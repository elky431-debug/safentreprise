...
/**
 * Fait défiler la valeur de 0 jusqu'à `cible` au montage.
 * Retourne directement la valeur finale si l'utilisateur a demandé à
 * réduire les animations, ou si le compteur est à zéro.
 */
function useCompteurAnime(cible: number): number {
  ...
  useEffect(() => {
    ...
    const duree = animationsReduites || cible === 0 ? 0 : DUREE_ANIMATION_MS;
